...
The web sources scripts in this repository include some modifications that were written by me. The original web sources scripts without any of my modifications can be located at a website called [Mp3tag Community](https://community.mp3tag.de/).
...
* To view the original web sources scripts, [click here for Apple Music](https://community.mp3tag.de/t/ws-apple-music/51184/2) and [click here for the iTunes Store](https://community.mp3tag.de/t/ws-itunes/13478)
